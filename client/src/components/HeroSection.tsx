...
const TICKER: Record<Locale, { label: string; value: string }[]> = {
  en: [
    ...
    { label: "My delivery: full brand store", value: "7 days, ¥8,800" },
  ...
  zh: [
    ...
    { label: "找我：全套品牌站交付", value: "7 天，¥8,800" },
...
const COPY: Record<Locale, {
  ...
  en: {
    ...
    sub: "Every day you delay, Amazon takes 58% of your revenue. I build brand stores that generate orders from day one — 0% commission, 7-day delivery, no team needed.",
  ...
  zh: {
    ...
    sub: "每多拖一天，就多一天把利润拱手送给亚马逊。我帮跨境电商老板 7 天搭建从第一天就能收款的品牌独立站——0% 平台佣金，不等机构 3 个月，不用招一个团队。",
    cta1: "算一算你每年亏多少",
    cta2: "查看套餐",
