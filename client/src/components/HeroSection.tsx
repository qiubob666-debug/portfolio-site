...
const TICKER: Record<Locale, { label: string; value: string }[]> = {
  en: [
    ...
    { label: "Agency (Ruinuo/Sanxing tier) quote", value: "¥30,000–80,000/yr" },
    { label: "Agency avg. delivery time", value: "60–90 days" },
    { label: "Shopify + plugins annual cost", value: "¥25,000–40,000/yr" },
    { label: "Freelancer (template, no custom)", value: "¥3,000–8,000" },
  ...
  zh: [
    ...
    { label: "外贸建站机构（瑞诺/三行同级）报价", value: "¥3–8 万/年" },
    { label: "机构平均交付周期", value: "60–90 天" },
    { label: "Shopify + 插件年均持续支出", value: "¥2.5–4 万/年" },
    { label: "普通接单个人（模板，无定制）", value: "¥3,000–8,000" },
    { label: "找我：定制全栈品牌站交付", value: "10 天，¥8,800" },
    { label: "你的竞争对手已上线品牌站", value: "上周" },
  ],
  ja: [
    { label: "Amazon FBA 全費用率", value: "最大 58%" },
    { label: "代理店（瑞诺/三行同级）見積", value: "¥3–8万/年" },
    { label: "エージェンシーの平均納期", value: "60～90日" },
    { label: "Shopify+プラグイン年間コスト", value: "¥2.5～4万/年" },
    { label: "フリーランサー（テンプレートのみ）", value: "¥3,000～8,000" },
